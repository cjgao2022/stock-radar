...
| 页面 | 内容 |
|------|------|
| **大盘** | 市场情绪条（涨跌家数/涨停/跌停）、指数卡片、板块热力图、北向资金、行业资金流 TOP8、连板梯队、龙虎榜、THS 热门 TOP20 |
| **板块** | 概念/行业双 Tab，涨跌幅 + 领涨股 + 净流入，可排序 |
| **板块详情** | 构成股行情表 |
| **个股** | 持仓列表 + 名称/代码搜索（多结果展示、加入/移除持仓） |
| **ETF** | 持仓列表 + 名称/代码搜索（多结果展示、加入/移除持仓） |
...
| 涨停板 / 热门排行 | AKShare 东方财富 |
| 北向资金 | AKShare 东方财富沪深港通 |
...
- 东方财富板块构成股接口在部分网络环境下不可达，板块详情页会提示切换网络
